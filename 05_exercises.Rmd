...
garden_harvest %>% 
  ...
  ggplot() +
  geom_area(aes(x = date, y = daily_harvest_lb, fill = variety)) +
  labs(title = "look, a cool title")
```
...
I'm going to add someting to make this branch different.

I'm going to add something so I can try to undo a commit.
